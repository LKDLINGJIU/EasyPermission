package com.android.yucheng.permission_lib.provider;
...
import com.android.yucheng.permission_lib.ObtainTopActivity;

/**
 * Created by lingjiu on 2019/7/2.
 */
public class RequestPermissionProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ObtainTopActivity.getDefault().init((Application) getContext());
        return false;
    }
     ...
     */
    @Override
    public int update( @NonNull Uri uri,  ContentValues values,  @Nullable String selection,  String[] selectionArgs) {
        return 0;
    }
}
